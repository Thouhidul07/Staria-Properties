...
const PROJECTS = [
  ...
  { id: 4, name: "Eco Business Park", location: "Uttara, Dhaka", type: "Office & Retail", status: "Upcoming", statusBg: "bg-[#6366F1]", category: "Commercial", image: "https://images.unsplash.com/photo-1783705094622-f2c01a9787b5?w=900&h=700&fit=crop&auto=format&q=92", isDemo: true },
  { id: 5, name: "Skyline Villa Retreat", location: "Bashundhara, Dhaka", type: "Private Villa Estate", status: "Upcoming", statusBg: "bg-[#6366F1]", category: "Development", image: "https://images.unsplash.com/photo-1602343168117-bb8ffe3e2e9f?w=900&h=700&fit=crop&auto=format&q=92", isDemo: true },
  { id: 6, name: "The Meridian Suite", location: "Dhanmondi, Dhaka", type: "Interior Design", status: "Upcoming", statusBg: "bg-[#6366F1]", category: "Interior", image: "https://images.unsplash.com/photo-1663811397207-418a92396ad5?w=900&h=700&fit=crop&auto=format&q=92", isDemo: true },
];
              ...
              {displayedProjects.filter((p) => projectFilter === "All" || p.category === projectFilter).map((project, i) => (
                <motion.div key={project.id} initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 20 }} transition={{ duration: 0.6, delay: i * 0.08, ease: [0.22, 1, 0.36, 1] }}
                  ...
                  <div className="relative h-[300px] overflow-hidden bg-[#E0E0E0]">
                    ...
                    {project.isDemo && (
                      <div className="absolute left-1/2 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/92 px-7 py-2.5 text-center text-[0.78rem] font-bold uppercase tracking-[0.22em] text-[#0B5E3C] shadow-[0_10px_30px_rgba(0,0,0,0.20)] ring-1 ring-white/70 backdrop-blur-md" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                        Upcoming
                      </div>
                    )}
